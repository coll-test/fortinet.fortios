...
from ansible_collections.fortinet.fortios.plugins.module_utils.network.fortios.argspec.facts.facts import FactsArgs
from ansible_collections.fortinet.fortios.plugins.module_utils.network.fortios.argspec.system.system import SystemArgs
from ansible_collections.ansible.netcommon.plugins.module_utils.network.common.facts.facts import FactsBase
from ansible_collections.fortinet.fortios.plugins.module_utils.network.fortios.facts.system.system import SystemFacts
