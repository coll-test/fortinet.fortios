...
from ansible_collections.fortinet.fortios.tests.unit.modules.utils import exit_json, fail_json
from ansible_collections.fortinet.fortios.tests.unit.compat import unittest
from ansible_collections.fortinet.fortios.tests.unit.compat.mock import patch
from ansible.module_utils import basic
from ansible_collections.fortinet.fortios.plugins.module_utils.network.fortios.fortios import FortiOSHandler

try:
    from ansible_collections.fortinet.fortios.plugins.module_utils.network.fortios.facts.facts import Facts
    from ansible_collections.fortinet.fortios.plugins.modules import fortios_facts
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.fortinet.fortios.plugins.modules.fortios_facts.Connection')
...
def test_facts_get(mocker):
    ...
    monitor_method_mock = mocker.patch('ansible_collections.fortinet.fortios.plugins.module_utils.network.fortios.fortios.FortiOSHandler.monitor', return_value=monitor_method_result)
