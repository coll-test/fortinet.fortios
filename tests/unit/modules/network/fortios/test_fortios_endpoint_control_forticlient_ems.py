...
try:
    from ansible_collections.fortinet.fortios.plugins.modules import fortios_endpoint_control_forticlient_ems
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.fortinet.fortios.plugins.modules.fortios_endpoint_control_forticlient_ems.Connection')
