...
try:
    from ansible_collections.fortinet.fortios.plugins.modules import fortios_switch_controller_custom_command
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.fortinet.fortios.plugins.modules.fortios_switch_controller_custom_command.Connection')
