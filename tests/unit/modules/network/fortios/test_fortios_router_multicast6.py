...
try:
    from ansible_collections.fortinet.fortios.plugins.modules import fortios_router_multicast6
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.fortinet.fortios.plugins.modules.fortios_router_multicast6.Connection')
