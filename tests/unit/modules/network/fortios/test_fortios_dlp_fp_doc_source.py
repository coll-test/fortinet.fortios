...
try:
    from ansible_collections.fortinet.fortios.plugins.modules import fortios_dlp_fp_doc_source
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.fortinet.fortios.plugins.modules.fortios_dlp_fp_doc_source.Connection')
