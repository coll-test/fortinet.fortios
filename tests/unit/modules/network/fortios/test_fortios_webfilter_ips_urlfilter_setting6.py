...
try:
    from ansible_collections.fortinet.fortios.plugins.modules import fortios_webfilter_ips_urlfilter_setting6
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.fortinet.fortios.plugins.modules.fortios_webfilter_ips_urlfilter_setting6.Connection')
