...
try:
    from ansible_collections.fortinet.fortios.plugins.modules import fortios_switch_controller_802_1X_settings
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.fortinet.fortios.plugins.modules.fortios_switch_controller_802_1X_settings.Connection')
