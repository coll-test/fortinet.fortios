...
try:
    from ansible_collections.fortinet.fortios.plugins.modules import fortios_system_replacemsg_sslvpn
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.fortinet.fortios.plugins.modules.fortios_system_replacemsg_sslvpn.Connection')
