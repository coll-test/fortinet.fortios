...
try:
    from ansible_collections.fortinet.fortios.plugins.modules import fortios_firewall_internet_service_custom
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.fortinet.fortios.plugins.modules.fortios_firewall_internet_service_custom.Connection')
