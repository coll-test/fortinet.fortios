...
try:
    from ansible_collections.fortinet.fortios.plugins.modules import fortios_webfilter_ftgd_local_cat
except ImportError:
...
def connection_mock(mocker):
    connection_class_mock = mocker.patch('ansible_collections.fortinet.fortios.plugins.modules.fortios_webfilter_ftgd_local_cat.Connection')
